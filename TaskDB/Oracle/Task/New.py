...
Action to insert a new group into TaskDB
...
class New(DBFormatter):
    ...
    def execute(self, taskName, jobsetId, taskStatus, taskFailure, jobSw, jobArch, inputDataset, \
        ...
        self.sql += "tm_taskname,panda_jobset_id, tm_task_status, tm_start_time, tm_task_failure, tm_job_sw, \
		     tm_job_arch, tm_input_dataset, tm_site_whitlist, tm_site_blacklist, \
        ...
        self.sql += " VALUES (:task_name, :jobset_id, :task_status, :start_time, :task_failure, :job_type, :job_sw, \
 		     :job_arch, :input_dataset, :site_whitlist, :site_blacklist, :split_algo, :split_args, :user_sandbox, \
        ...
        binds = {"task_name": taskName, "jobset_id": jobsetId, "task_status": taskStatus, "start_time": self.format(time_res)[0][0], "task_failure": taskFailure, \
	         "job_sw": jobSw, "job_arch": jobArch, "input_dataset": inputDataset, "site_whitlist": siteWhitelist, \
