...
class HTTPRequests(dict):
    ...
    def __init__(self, url='localhost', localcert=None, localkey=None):
        """
...
#            headers["Content-length"] = len(data)
        ...
        #    print exc
        #    print dir(exc)
        #    for ciccio in ['args', 'headers', 'message', 'reason', 'req_data', 'req_headers', 'result', 'status', 'url']:
        #        print getattr(exc, ciccio)
